...
public class Listeners extends TestListenerAdapter {
    ...
    public void onStart(ITestContext testContext) {
        ...
        htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/test-output/DeckOfCardsReport.html");

        htmlReporter.config().setDocumentTitle("DeckOfCards API Automation Report"); // Tile of report
        htmlReporter.config().setReportName("API Testing Report"); // name of the report
        htmlReporter.config().setTheme(Theme.STANDARD);

        extent = new ExtentReports();
        extent.attachReporter(htmlReporter);
        extent.setSystemInfo("Project Name", "DeckOfCards Api");
